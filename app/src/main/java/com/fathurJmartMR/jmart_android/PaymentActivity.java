...
import com.fathurJmartMR.jmart_android.request.CreatePaymentRequest;
import com.fathurJmartMR.jmart_android.request.RequestFactory;
import com.google.gson.Gson;

/**
 * Activity Class untuk Payment Page
 *
 * @author Fathurrahman Irwansa
 * @version Final
 */
public class PaymentActivity extends AppCompatActivity {
    public static final String EXTRA_AMOUNT = "com.fathurJmartMR.jmart_android.EXTRA_AMOUNT";
    public static final String EXTRA_SHIPMENTADDRESS = "com.fathurJmartMR.jmart_android.EXTRA_SHIPMENTADDRESS";
            ...
            public void onClick(View v) {
                ...
                if(isEmpty(et_shipmentAddress)){
                    ...
                    CreatePaymentRequest createPaymentRequest = new CreatePaymentRequest(String.valueOf(LoginActivity.getLoggedAccount().id), String.valueOf(productId), et_amountPayment.getText().toString(), et_shipmentAddress.getText().toString(), String.valueOf(shipmentPlans),
                        ...
                        @Override
                        public void onErrorResponse(VolleyError error) {
                            Toast.makeText(getApplicationContext(), "Create payment unsuccessful, Can't connect with server", Toast.LENGTH_LONG).show();
                        }
                    });
